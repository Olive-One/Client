...
import {
  useExpenseOverviewByChurch,
  useExpensePaymentsListByChurch,
...
export function ExpensePayments({ onExport }: ExpensePaymentsProps = {}) {
  ...
  const { data: ExpenseOverview } = useExpenseOverviewByChurch();
  ...
  const { data: payments } = useExpensePaymentsListByChurch({
    ...pagination,
  ...
  const columns = useMemo<ColumnDef<ExpensePayments>[]>(
    () => [
      {
        id: "member",
        header: "Member",
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-3">
            ...
            <CardTitle className="text-2xl text-foreground flex items-center">
              ...
              {ExpenseOverview?.data.totalExpense.toLocaleString("en-IN", {
                minimumFractionDigits: 2,
              }) || 0}
            </CardTitle>
          </CardHeader>
        ...
        <Card className="border shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-3">
            ...
            <CardTitle className="text-2xl text-foreground flex items-center">
              <IndianRupee className="w-5 h-5" />
              {ExpenseOverview?.data.pendingAmount.toLocaleString(
                "en-IN",
                { minimumFractionDigits: 2 }
              ) || 0}
            </CardTitle>
        ...
        <Card className="border shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-3">
            ...
            <CardTitle className="text-2xl text-foreground flex items-center ">
              <IndianRupee className="w-5 h-5" />
              {ExpenseOverview?.data.overdueAmount.toLocaleString(
                "en-IN",
                { minimumFractionDigits: 2 }
              ) || 0}
            </CardTitle>
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Search expenses, vendors, or transaction numbers..."
      ...
      {/* Expense Table Header with Export */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        <div>
          <h3 className="text-lg font-semibold text-foreground">
            Expense Transactions ({payments?.data.totalCount || 0} expenses found)
          </h3>
          <p className="text-sm text-muted-foreground">
            Manage and export expense payment data
          </p>
        </div>
